...
The translations made a big impact on our score and ranking, which justifies the name for this field: **data** science, not **algorithm** science. We missed out on translating many words until the very end of the competition. On the final day, we were in 9th place. However, after performing translations on (1) the beauty and fashion datasets (which we completely missed out) and (2) the test set titles, we parachuted into 4th place. The score jumped from 46.5% to 46.8%, which is quite a lot when you're near the top of the leaderboard. 
